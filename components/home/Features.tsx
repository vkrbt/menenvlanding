...
const FEATURES: Feature[] = [
  {
    ...
    body: '3 часа в Zoom. Без затянутых монологов. Достаточно, чтобы произошло важное. Недостаточно, чтобы устать',
  ...
  },
  {
    ...
    body: 'Слушаешь новые выпуски раньше всех, пока они ещё не вышли в публичный доступ',
  },
  {
    icon: (
      <>
    ...
    body: 'Контент, который не выходит в подкаст. Для тех, кому мало трех часов раз в две недели.',
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: 'Нетворкинг',
    body: 'Встречи между участниками — возможность узнать другого человека тет-а-тет. Из таких бесед часто рождаются настоящие связи.',
  },
  {
    icon: (
      <>
    ...
    body: (
      <>
        <b>В планах:</b> тематические группы для тех, кто хочет глубже. Офлайн-встречи. Стримы с приглашенными спикерами. Комьюнити растёт — а вместе с ним и возможности.
      </>
    ),
  },
]
