...
const CARDS: Array<{ icon: ReactNode; title: string; body: string }> = [
  {
    ...
    body: 'Записался и не пришёл — встреча всё равно считается оплаченной. Иначе состав не удержать.',
  },
  {
    icon: (
      <>
    ...
    body: 'Знаешь заранее, что не сможешь, — просто напиши до встречи. Остальные рассчитывают, что ты будешь.',
  },
  {
    icon: (
      <>
    ...
    title: 'Группа держится на тех, кто ходит',
    body: 'Разговор складывается, когда из раза в раз собираются одни и те же люди. Поэтому регулярность работает не только на тебя.',
  },
]
