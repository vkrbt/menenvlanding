...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Материалы блога «Мужской среды», страница ${page}: одиночество, выгорание, эмиграция, отношения, отцовство. Пишут гештальт-терапевт и психиатр.`,
        ...
        <section className="blog-hero">
          <div className="container">
            ...
            <p className="blog-hero__sub">
              ...
              отношения. Пишут ведущие «Мужской среды» — гештальт-терапевт и психиатр.
            </p>
          </div>
        </section>
