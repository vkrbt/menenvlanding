...
const STEPS = [
  ...
  },
  {
    n: 2,
    title: 'Разговор',
    body: 'Ведут двое: психолог и психиатр. Это не приём и не терапия — ведущие держат рамку и следят, чтобы разговор не сваливался в советы и оценки.',
  },
  {
    n: 3,
    title: 'Обмен',
      ...
      <main>
        ...
        <section className="container meeting-section">
          ...
          <p className="meeting-note">
            ...
            Ведущие по профессии психолог и психиатр, но встреча не является ни приёмом,
