...
export const metadata: Metadata = {
  ...
  description:
    'Закрытое онлайн-сообщество для мужчин 25+. Встречи в Zoom раз в две недели, ведущие — гештальт-терапевт и психиатр. Подкаст, нетворкинг, закрытый чат. Русскоязычные мужчины по всему миру.',
